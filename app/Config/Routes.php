...
$routes->get('Admin/SaveAttendance/ExportExcel', 'ConAdminSaveAttendance::ExportAttendanceExcel');
...
$routes->post('Admin/PaAgreement/save-config', 'ConAdminPaAgreement::saveConfig');
