                                        ...
                                        if ($item['ri_part'] == 1):
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="1" data-part="1"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 1) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="2" data-part="1"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 2) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="3" data-part="1"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 3) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="4" data-part="1"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 4) ? 'checked' : ''; ?>>
                                                </td>
                                                <td><input type="number" class="form-control form-control-sm" min="0" max="4" data-part="1"
                                    ...
                                    foreach ($rubricItems as $item):
                                        if ($item['ri_part'] == 1):
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="1"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 1) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="2"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 2) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="3"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 3) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="4"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 4) ? 'checked' : ''; ?>>
                                                </td>
                                                <td><input type="number" class="form-control form-control-sm" min="0" max="4"
                                                        name="points_<?= esc($item['ri_id']); ?>"
                                                        value="<?= isset($itemScores[$item['ri_id']]) ? esc($itemScores[$item['ri_id']]) : ''; ?>">
                                                </td>
                                            </tr>
                                    ...
                                    foreach ($rubricItems as $item):
                                        if ($item['ri_part'] == 2):
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="1" data-part="2"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 1) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="2" data-part="2"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 2) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="3" data-part="2"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 3) ? 'checked' : ''; ?>>
                                                </td>
                                                <td class="text-center"><input class="form-check-input" type="radio"
                                                        name="score_<?= esc($item['ri_id']); ?>" value="4" data-part="2"
                                                        <?= (isset($itemScores[$item['ri_id']]) && $itemScores[$item['ri_id']] == 4) ? 'checked' : ''; ?>>
                                                </td>
                                                <td><input type="number" class="form-control form-control-sm" min="0" max="20" data-part="2"
                                                        name="points_<?= esc($item['ri_id']); ?>"
                                                        value="<?= isset($itemScores[$item['ri_id']]) ? esc($itemScores[$item['ri_id']]) : ''; ?>">
                                                </td>
                                            </tr>
...
document.addEventListener('DOMContentLoaded', function() {
    const scoreRadios = document.querySelectorAll('input[type="radio"][name^="score_"]');
    const pointsInputs = document.querySelectorAll('input[type="number"][name^="points_"]');

    function calculateTotalScores() {
        let part1Total = 0;
        // Assuming all rubric items are part of Part 1 for now, adjust if Part 2 exists
        pointsInputs.forEach(input => {
            const score = parseInt(input.value) || 0;
            part1Total += score;
        });

        // For simplicity, let's assume Part 1 is 60 points and Part 2 is 40 points,
        // and total score is a direct sum of all points_ inputs.
        // You might need more complex logic here based on your rubric structure.
        const totalScore = part1Total; // Placeholder, adjust as needed

        document.getElementById('totalScore1').textContent = part1Total;
        document.querySelector('input[name="totalScore1"]').value = part1Total;

        // Assuming Part 2 is not yet implemented or always 0 for this form
        const part2Total = 0;
    ...
    scoreRadios.forEach(radio => {
        radio.addEventListener('change', function() {
            const itemId = this.name.replace('score_', '');
    ...
    pointsInputs.forEach(input => {
        input.addEventListener('change', function() {
            calculateTotalScores(); // Recalculate totals if points input is changed directly
        });
    });
    ...
    function validateRadioButtons() {
        let isValid = true;
        const rubricItems = document.querySelectorAll('input[type="radio"][name^="score_"]');
