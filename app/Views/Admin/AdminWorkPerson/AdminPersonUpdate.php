    ...
    <div class="col-lg-2">
        <div class="card mb-4 mb-xl-0">
            <div class="card-body text-center">
                <img class="mb-2 img-fluid" id="output" src="<?=base_url('uploads/admin/Personnal/'.$Pers->pers_img);?>" alt="">
                <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                <form id="ChangeImgPersonnal" enctype="multipart/form-data">
                    <span class="btn btn-primary btn-file">
                        เปลี่ยนรูปภาพ <input type="file" name="pers_img" id="pers_img" onchange="loadFile(event)" key-persid="<?=$Pers->pers_id?>">
                    </span>
                </form>
            </div>
        </div>
            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                        ...
                        <i class="tf-icons bx bx-home me-1"></i> ข้อมูลทั่วไป
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-profile" aria-controls="navs-pills-justified-profile" aria-selected="false" tabindex="-1">
                        <i class="tf-icons bx bx-user me-1"></i> ประวัติส่วนตัว
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-messages" aria-controls="navs-pills-justified-messages" aria-selected="false" tabindex="-1">
                        <i class="tf-icons bx bx-message-square me-1"></i> การศึกษา
                    </button>
                </li>
            </ul>
