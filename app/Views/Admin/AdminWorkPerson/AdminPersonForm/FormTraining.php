<div class="col-12">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h6 class="fw-bold text-primary mb-0 d-flex align-items-center">
            <i class='bx bx-book-open fs-4 me-2'></i> ประวัติการฝึกอบรมและสัมมนา
        </h6>
        <button type="button" class="btn btn-outline-primary btn-sm fw-bold px-3 py-2 rounded-3" data-bs-toggle="modal" data-bs-target="#trainingModal">
            <i class='bx bx-plus me-1'></i> เพิ่มประวัติการอบรม
        </button>
    </div>
