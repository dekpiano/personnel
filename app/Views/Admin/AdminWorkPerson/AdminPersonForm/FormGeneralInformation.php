<form class="needs-validation" novalidate="" id="FormPersonnalUpdateDataGeneral"
                                    enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <div class="col-md-9">
                                            <?php $status = array('กำลังใช้งาน','ย้ายสถานศึกษา','ลาออก','เกษียรอายุ'); ?>
                                            <div class="form-floating">
                                                <select class="form-select pers_status" id="pers_status" name="pers_status"
                                                    required="">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="pers_id" name="pers_id"
                                                    placeholder="" value="<?=$Pers->pers_id?>" required="" readonly>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <select class="form-select pers_prefix" id="pers_prefix" name="pers_prefix"
                                                    required="">
                                                    <option value="">เลือก...</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" class="form-control pers_firstname" id="pers_firstname"
                                                    name="pers_firstname" placeholder=""
                                                    value="" required="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" class="form-control pers_lastname" id="pers_lastname"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <select class="form-select pers_position" id="pers_position" name="pers_position"
                                                    required="">
                                                    <option value="">เลือก...</option>
                                                    <?php foreach ($position as $key => $value) : ?>
                                                    <option 
                                                        value="<?=$value->posi_id;?>"><?=$value->posi_name;?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
