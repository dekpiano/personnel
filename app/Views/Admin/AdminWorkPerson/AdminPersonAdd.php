        ...
        <div class="col-lg-3">
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    <img class="mb-2 img-fluid" id="output" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-9">
                            ...
                            <div class="invalid-feedback">กรุณากรอกเลือกสถานะผู้ใช้งาน</div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="pers_id" name="pers_id" placeholder="" value="<?=$pers_id;?>" required="" readonly>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">กรุณากรอกเลือกคำนำหน้า</div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="pers_firstname" name="pers_firstname" placeholder="" value="" required="">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="pers_lastname" name="pers_lastname" placeholder="" value="" required="">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="tel" class="form-control pers_phone" id="pers_phone" name="pers_phone" placeholder="" value="">
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <input type="email" class="form-control" id="pers_username" placeholder="ให้ใช้อีเมลของโรงเรียน" name="pers_username">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">กรุณาเลือกตำแหน่งทางการศึกษา</div>
                        </div>
                        <div class="col-md-4" style="display:none;" id="show_position">
                            ...
                            <div class="invalid-feedback">กรุณาเลือกตำแหน่งหลัก</div>
                        </div>
                    </div>
